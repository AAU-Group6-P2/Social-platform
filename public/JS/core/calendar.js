import { getEvents, getEventJoinCount, getUserRole } from "../pages/clubServices.js";
import { setupEventJoinButton } from "../pages/eventJoinButton.js";
...
async function openEventPage(event) {
    ...
    if(role === "student"){
        ...
        const joinCount = container.querySelector("#event-join-count");
