...
/*Sends request to backend to undo joining the given event */
export async function undoJoinEvent(eventId) {
    const res = await fetch(`/events/${eventId}/joined`, {
        method: "DELETE",
        credentials: "include"
    });
...
/*Sends request to backend to undo joining the given club */
export async function undoJoinClub(clubId) {
    const res = await fetch(`/clubs/${clubId}/joined`, {
        method: "DELETE",
        credentials: "include"
    });
